...
export default function NavClient() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-white" style={{ borderBottom: "1px solid var(--border)" }}>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white px-6 pb-4 flex flex-col gap-3" style={{ borderTop: "1px solid var(--border)" }}>
          {navLinks.map((link) => (
